...
/// @notice An example contract using the SmartSwap flash function
contract PairFlash is ISmartSwapFlashCallback, PeripheryPayments {
    ...
    /// @notice Calls the pools flash function with data needed in `SmartSwapFlashCallback`
